...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{adam_optimization_results/comparison_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{optimal_muon_suite_results/comparison_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{comparison_plot.png}
    \caption{Final Comparison: Validation loss curves for optimized Muon vs. optimized Adam.}
